...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Turtle alice = new Turtle();
        Turtle bob = new Turtle();
        Turtle charlie = new Turtle();
        // Create threads for drawing shapes
        Thread triangleThread = new Thread(() -> drawTriangle(alice));
        Thread squareThread = new Thread(() -> drawSquare(bob));
        Thread circleThread = new Thread(() -> drawCircle(charlie));
    ...
    public static void drawTriangle(Turtle turtle) {
